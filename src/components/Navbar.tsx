        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          >
            {darkMode ? (
              ...
              // Moon Icon (Dark Mode)
              <svg className="w-5 h-5 text-chumbo-light hover:text-royal-blue transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="flex md:hidden items-center gap-3">
          ...
          >
            {darkMode ? (
              ...
              <svg className="w-5 h-5 text-chumbo-light" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
              </svg>
            )}
          </button>
