...
export default function Footer({ t }: FooterProps) {
  return (
    <footer className="bg-chumbo text-offwhite py-16 border-t border-white/5 relative overflow-hidden">
      {/* Decorative connection nodes background */}
      <div className="absolute right-[-100px] bottom-[-100px] w-96 h-96 rounded-full bg-royal-blue/5 blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-start mb-16">
          ...
          <div className="md:col-span-3 flex flex-col items-start gap-4">
            ...
            <div className="flex flex-col gap-3.5 font-sans text-sm font-medium text-offwhite-darker/70 w-full">
              ...
              >
                <svg className="w-5 h-5 text-offwhite-darker/60 group-hover:text-royal-blue transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 hover:text-white transition-colors duration-200 group"
              >
                <svg className="w-5 h-5 text-offwhite-darker/60 group-hover:text-royal-blue transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
